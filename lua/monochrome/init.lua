...
function M.setup()
	...
	hi("Directory", { fg = c.white })
	hi("Question", { fg = c.white })
	hi("MoreMsg", { fg = c.white })
	hi("ModeMsg", { fg = c.white })
	hi("QuickFixLine", { fg = c.white })
	hi("CursorLine", { bg = c.gray1 })
	hi("CursorColumn", { bg = c.gray1 })
	hi("Visual", { bg = c.gray2 })
	hi("Search", { fg = c.white, bg = c.yellow })
	hi("IncSearch", { fg = c.white, bg = c.yellow })
	...
	hi("Todo", { fg = c.white, bg = c.yellow, bold = true })
